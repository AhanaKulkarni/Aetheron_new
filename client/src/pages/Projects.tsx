  ...
  const projects = [
{
  ...
  cta: "Visit Project",
...

    {
      ...
      title: "Neural Engine",
      description:
        "Advanced machine learning platform currently in development. Breakthrough AI technology coming soon.",
      category: "AI Health",
      status: "Upcoming",
      image:
    ...
    },
    {
      ...
      description:
        "Next-generation quantum computing solutions for complex data analysis. Revolutionary technology in development.",
      category: "Quantum",
      status: "Upcoming",
      image:
    ...
    },
    {
      ...
      description:
        "Intelligent robotics platform for autonomous operations. Next-generation technology coming soon.",
      category: "Robotics",
      status: "Upcoming",
      image:
    ...
    },
    {
      ...
      description:
        "Advanced decentralized finance platform with AI-powered insights. Revolutionary fintech coming soon.",
      category: "FinTech",
      status: "Upcoming",
      image:
    ...
    },
    {
      ...
      description:
        "Revolutionary neural network architecture that enhances AI reasoning capabilities. Advanced technology in development.",
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          >
            ...
            <p className="text-lg text-white/70 max-w-3xl mx-auto font-light leading-relaxed">
              ...
              Each solution represents innovation at the intersection of vision
              and execution.
            </p>
          </motion.div>
          ...
          >
            <div className="glassmorphism p-12 rounded-2xl max-w-4xl mx-auto">
              <h3 className="text-3xl font-space font-bold mb-6">
                Have a Project in Mind
              </h3>
              <p className="text-xl text-gray-300 mb-8">
                Join our marketplace and bring your revolutionary ideas to life
                with our expert team and cutting-edge technology.
              </p>
